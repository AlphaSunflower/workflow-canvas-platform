...
test('normalizeStoryboardOutputRoutingIdentity backfills the shared node-level output handle', () => {
...
test('normalizeStoryboardTaskRefIdentity repairs legacy storyboard task refs missing task type and output handle', () => {
  ...
  assert.equal(taskRef.outputHandle, getAIStoryboardOutputHandle('group-1'));
