...
import { generateNodeId, MAX_NODE_ID, NODE_ID_EXHAUSTED_ERROR, } from './node-id.shared';
export { generateNodeId, MAX_NODE_ID, NODE_ID_EXHAUSTED_ERROR, } from './node-id.shared';
/**
 * 浠庢樉绀哄瓧绗︿覆瑙ｆ瀽鑺傜偣ID搴忓垪鍙? * @param display - 鑺傜偣ID鏄剧ず瀛楃涓诧紙濡?#00001锛? * @returns 搴忓垪鍙锋垨null锛堣В鏋愬け璐ユ椂锛? */
export function parseNodeIdDisplay(display) {
    var match = display.match(/^#(\d{5})$/);
    if (!match) {
        return null;
    }
 ...
 */
export function createNodeIdGenerator(initialLastIssued) {
